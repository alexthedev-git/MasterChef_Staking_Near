...
export const {
  ...
  walletUrl,
  nameSuffix,
  stakingContractName: stakingContractId,
  nftContractName: nftContractId,
} = getConfig();

// export const marketId = 'market.' + contractId;
export const marketId = stakingContractId;
...
export const initNear =
  ...
  async ({ update, getState, dispatch }) => {
    ...
    wallet.signIn = () => {
      wallet.requestSignIn(stakingContractId, "Blah Blah");
    };
